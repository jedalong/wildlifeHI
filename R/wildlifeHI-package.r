...
#'
#' @description A suite of basic tools for studying how wildlife are impacted by human infrastructure using tracking data. It focuses largely on working with Open Street Map (OSM) data using the package \code{osmdata}. It allows the user to easily perform distance, crossing, and buffer analysis.
#'
